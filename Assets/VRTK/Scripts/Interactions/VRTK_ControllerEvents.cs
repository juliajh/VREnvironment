...
namespace VRTK
{
    ...
    public class VRTK_ControllerEvents : MonoBehaviour
    {
        ...
        public bool touchpadout()
        {
            VRTK_ControllerReference controllerReference = VRTK_ControllerReference.GetControllerReference(gameObject);
            if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.Touchpad, SDK_BaseController.ButtonPressTypes.PressUp, controllerReference))
                return true;
            else
                return false;
