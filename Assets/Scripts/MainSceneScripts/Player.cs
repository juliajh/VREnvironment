...
public class Player : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        {
            player.transform.localPosition = new Vector3(49.12f, 0.9f, 37.15f);
        }
    ...
    void Update()
    {
        ...
        if (StoreDoor.GetComponent<Opendoor>().scenechange)
        {
            StartCoroutine("fadein");
            if (checkbool)
            {
    ...
    public void LoadCrop()
    {
        ...
        for (int i = 0; i < SqlDB.farmplantList.Count; i++)
        {
            ...
            plant.transform.FindChild("plant_nametag").GetChild(2).GetComponent<TextMesh>().text = SqlDB.farmplantList[i].master;
